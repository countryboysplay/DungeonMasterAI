...
public sealed class DmToolRouter(GameEngine engine, DiceService dice, RulesSearchService rules)
{
    ...
    [
        ...
        Tool("cast_spell", "Cast one prepared spell through the deterministic spell engine. Player-character single-target spell attacks create required player attack and damage rolls; NPC spell attacks still resolve automatically. The engine validates spell slots, components, turn limits, saves, healing, upcasting, Rituals, and Concentration.", Props(("character_id","string",true),("spell_id","string",true),("target_id","string",false),("slot_level","integer",false),("as_ritual","boolean",false),("encounter_id","string",false))),
