    ...
    public async Task LoadAsync(string path, CancellationToken cancellationToken = default)
    {
        ...
        foreach (var node in spellsNode.EnumerateArray())
        {
            ...
            spells.Add(new SpellDefinition
            {
                ...
                ExcludedTargetCreatureType = String(node, "excluded_target_creature_type") ?? "",
                ConditionsEndedOnTarget = String(node, "conditions_ended_on_target") ?? "",
                ...
                AreaWidthFeet = Int(node, "area_width_feet") is var aw && aw > 0 ? aw : SpellAreaGeometry.DefaultLineWidthFeet,
